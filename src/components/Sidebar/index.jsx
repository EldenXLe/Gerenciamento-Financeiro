...
import { FiGrid, FiRepeat, FiBarChart2, FiSettings, FiZap, FiLogOut } from 'react-icons/fi';
...
export default function Sidebar({ onClose }) {
  ...
  return (
    <aside className="flex flex-col h-full w-64 bg-[#111118] border-r border-[#ffffff08]">
      {/* Logo */}
      ...
      <div className="p-4 border-t border-[#ffffff08]">
        <div className="flex items-center gap-3">
          ...
          <button onClick={logout}
            className="p-1.5 rounded-lg text-[#55556a] hover:text-[#f05a5a] transition-colors" title="Sair">
            <FiLogOut size={15} />
          </button>
        </div>
      </div>
